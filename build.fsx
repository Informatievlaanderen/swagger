...
Target.create "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.AspNetCore.Swagger")

Target.create "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.AspNetCore.Swagger")
