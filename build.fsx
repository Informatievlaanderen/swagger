...
Target "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.AspNetCore.Swagger")

Target "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.AspNetCore.Swagger")
Target "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.AspNetCore.Swagger")
